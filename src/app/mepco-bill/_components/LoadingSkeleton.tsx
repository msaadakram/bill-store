  ...
  return (
    ...
    >
      ...
      <div className="p-6 space-y-5">
        <div className="h-28 bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl animate-pulse" />
        ...
        <div className="flex gap-3">
          <div className="flex-1 h-12 bg-emerald-100 rounded-lg animate-pulse" />
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/85 backdrop-blur-sm rounded-2xl">
        ...
        <p className="text-slate-400 mt-1" style={{ fontSize: "13px" }}>Connecting to MEPCO servers</p>
