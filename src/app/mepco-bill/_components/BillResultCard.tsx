      ...
      >
        ...
        <div className="flex items-center gap-3 md:gap-4 relative">
          ...
          <div>
            ...
            >
              MEPCO Bill Statement
            </div>
            <div className="text-emerald-200" style={{ fontSize: "12px" }}>
              {bill.billMonth}
            </div>
          </div>
        </div>
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              {(item as any).copy && (
                <button
                  onClick={handleCopy}
                  className="shrink-0 w-7 h-7 rounded-lg flex items-center justify-center bg-white border border-slate-200 hover:border-emerald-400 hover:bg-emerald-50 transition-colors"
                >
                  {copied ? (
