      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div>
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: "13px", fontWeight: 600 }}
              >
                MEPCO — Official Bill Check Portal
              </span>
            </motion.div>
            ...
            >
              Check Your MEPCO Electricity Bill Online
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-emerald-200 mb-6 md:mb-8"
              style={{
                fontSize: "clamp(15px, 2vw, 17px)",
                lineHeight: 1.7,
              }}
            >
              Multan Electric Power Company (MEPCO) serves over{" "}
              <strong className="text-white">4 million consumers</strong> in
              Multan &amp; south Punjab. Instantly check and download your
              bill.
            </motion.p>
          ...
          <div className="flex items-center justify-center lg:justify-end order-first lg:order-none mb-6 lg:mb-0">
            <img
              src="/company_logos/mepco_logo.webp"
              alt="MEPCO Logo"
