  ...
  return (
    <div className="space-y-5 lg:sticky lg:top-8 h-fit">
      ...
      <motion.div
        ...
        className="rounded-xl overflow-hidden shadow-lg shadow-emerald-900/10"
        style={{
        ...
        <div className="p-6">
          <div className="flex items-center gap-4 mb-5">
            ...
            <div>
              ...
              <div className="text-emerald-200" style={{ fontSize: "13px" }}>
          ...
          <div className="space-y-3">
            {[
              { text: "MEPCO Helpline: 118" },
              { text: "MEPCO HQ, Multan" },
              { text: "MEPCO Bill Support: 24/7" },
            ].map((item) => (
              <div
                key={item.text}
      ...
      >
        ...
        >
          Check Other Electricity Bills Online
        </h3>
        <div className="space-y-2">
          {[
            {
              name: "Check LESCO Bill Online",
              color: "#1D4ED8",
              bg: "#EFF6FF",
              path: "/lesco-bill",
            },
            {
              name: "Check FESCO Bill Online",
              color: "#7C3AED",
              bg: "#F5F3FF",
              path: "/fesco-bill",
            },
            {
              name: "Check IESCO Bill Online",
              color: "#3E8B8E",
              bg: "#F0F9FF",
