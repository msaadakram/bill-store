...
/** Generate a randomised mock GEPCO bill for demo purposes */
export function mockBill(ref: string, mode: InputMode): BillDetails {
  ...
  const addresses = [
    "House #12-A, Street 7, Satellite Town, Gujranwala",
    "Plot 88, Model Town, Gujranwala",
    "Bungalow 45, GT Road, Gujranwala",
    "House #102, Cantt Area, Gujranwala",
    "Flat 3B, Civil Lines, Gujranwala",
    "Shop #7, G.T.S. Market, Sialkot",
    "House #33, Mohallah Islamia, Gujranwala",
    "Plot 21, Industrial Estate, Gujranwala",
  ];
  ...
  return {
    ...
    referenceNo: mode === "reference" ? ref : `0621${ref.padEnd(10, "0").slice(0, 10)}`,
    customerId: mode === "customer" ? ref : `GID-${ref.slice(0, 6)}`,
