...
export function GepcoSidebar({
  ...
  return (
    <div className="space-y-5 lg:sticky lg:top-8 h-fit">
      ...
      {/* GEPCO bill check online — keyword anchor */}
      <span className="hidden" aria-hidden="true">gepco bill online check by reference number</span>
      ...
      <motion.div
        ...
        className="rounded-xl overflow-hidden shadow-lg shadow-amber-900/10"
        style={{
        ...
        <div className="p-6">
          <div className="flex items-center gap-4 mb-5">
            ...
            <div>
              ...
              <div className="text-amber-200" style={{ fontSize: "13px" }}>
