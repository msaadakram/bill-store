          ...
          <div>
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: "13px", fontWeight: 600 }}
              >
                GEPCO — Official Bill Check Portal
              </span>
            </motion.div>
            ...
            >
              Check Your GEPCO Electricity Bill Online
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-amber-200 mb-6 md:mb-8"
              style={{
                fontSize: "clamp(15px, 2vw, 17px)",
                lineHeight: 1.7,
              }}
            >
              Gujranwala Electric Power Company (GEPCO) serves over{" "}
              <strong className="text-white">3 million consumers</strong> in
              Gujranwala &amp; north Punjab. Instantly check and download your
              bill.
            </motion.p>
