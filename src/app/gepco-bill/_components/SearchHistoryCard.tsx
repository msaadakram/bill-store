    ...
    return (
      ...
      >
        <div
          ...
          style={{
            background: "linear-gradient(90deg, #92400E, #D97706, #FDE68A)",
          }}
        />
        <div className="p-4">
            ...
            >
              ...
              <div className="flex items-center gap-3 pl-4 pr-3 py-3">
                ...
                <button
                  ...
                  className="w-5 h-5 rounded-md flex items-center justify-center bg-amber-100 hover:bg-red-50 transition-colors shrink-0"
                >
