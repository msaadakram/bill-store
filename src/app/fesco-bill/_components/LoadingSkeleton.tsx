  ...
  return (
    ...
    >
      ...
      <div className="p-6 space-y-5">
        <div className="h-28 bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl animate-pulse" />
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/85 backdrop-blur-sm rounded-2xl">
        <div className="relative mb-4">
          ...
          <motion.div
            ...
            className="absolute inset-0 w-20 h-20 rounded-full border-4 border-transparent border-t-purple-500"
          />
        ...
        <p className="text-slate-400 mt-1" style={{ fontSize: "13px" }}>Connecting to FESCO servers</p>
