  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #5B21B6 0%, #7C3AED 60%, #A78BFA 100%)",
        }}
      >
        ...
        <div className="flex items-center gap-3 md:gap-4 relative">
          ...
          <div>
            ...
            >
              FESCO Bill Statement
            </div>
            <div className="text-purple-200" style={{ fontSize: "12px" }}>
              {bill.billMonth}
            </div>
          </div>
        </div>
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              {(item as any).copy && (
                <button
                  onClick={handleCopy}
                  className="shrink-0 w-7 h-7 rounded-lg flex items-center justify-center bg-white border border-slate-200 hover:border-purple-400 hover:bg-purple-50 transition-colors"
                >
                  {copied ? (
