          ...
          <div>
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: "13px", fontWeight: 600 }}
              >
                SNGPL -- Official Bill Check Portal
              </span>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-blue-200 mb-6 md:mb-8"
              style={{
                fontSize: "clamp(15px, 2vw, 17px)",
                lineHeight: 1.7,
              }}
            >
              Sui Northern Gas Pipelines Limited (SNGPL) serves over{" "}
              <strong className="text-white">6 million consumers across northern Pakistan</strong> in
              Punjab &amp; Khyber Pakhtunkhwa. Instantly check and download your
              gas bill.
            </motion.p>
