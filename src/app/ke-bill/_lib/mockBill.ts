...
/** Generate a randomised mock KE bill for demo purposes */
export function mockBill(ref: string, mode: InputMode): BillDetails {
  ...
  const addresses = [
    "House #12-A, Block 5, Gulshan-e-Iqbal, Karachi",
    "Plot 88, DHA Phase 6, Karachi",
    "Bungalow 45, Clifton Block 4, Karachi",
    "House #102, Gulistan-e-Jauhar Block 13, Karachi",
    "Flat 3B, PECHS Block 6, Karachi",
    "Shop #7, Saddar Bazaar, Karachi",
  ];
  ...
  return {
    ...
    referenceNo: mode === "reference" ? ref : `0721${ref.padEnd(10, "0").slice(0, 10)}`,
    customerId: mode === "customer" ? ref : `KE-${ref.slice(0, 6)}`,
