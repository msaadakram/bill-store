          ...
          <div>
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: "13px", fontWeight: 600 }}
              >
                K-Electric — Official Bill Check Portal
              </span>
            </motion.div>
            ...
            >
              Check Your K-Electric Electricity Bill Online
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-red-200 mb-6 md:mb-8"
              style={{
                fontSize: "clamp(15px, 2vw, 17px)",
                lineHeight: 1.7,
              }}
            >
              K-Electric (KE) serves over{" "}
              <strong className="text-white">3.5 million consumers</strong> in
              Karachi &amp; surrounding areas. Instantly check and download your
              bill.
            </motion.p>
