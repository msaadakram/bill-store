    ...
    >
      ...
      <div className="text-center mb-10 md:mb-14">
        ...
        <p className="text-slate-500 max-w-2xl mx-auto px-4" style={{ fontSize: "16px", lineHeight: 1.6 }}>
          A complete step-by-step guide covering every method — online portal, SMS, mobile app, and more. Learn how to get a duplicate K-Electric bill, understand your reference number, and read your bill amount.
        </p>
      </div>
  ...
  return (
    <div className="max-w-3xl mb-10 pl-4 border-l-4 border-red-400 bg-red-50/30 rounded-r-xl py-4 pr-4">
      <p className="text-slate-600 italic" style={{ fontSize: "16px", lineHeight: 1.85 }}>
        K-Electric — the <strong className="text-slate-800">Karachi Electric Supply Company</strong> — is Pakistan&apos;s only vertically integrated power utility, serving over <strong className="text-slate-800">3.5 million consumers</strong> across Karachi and surrounding areas including DHA, Clifton, Gulshan-e-Iqbal, and beyond. In the digital age, checking your electricity bill no longer requires standing in long queues or waiting for a physical copy to arrive in the post. This comprehensive guide walks you through every method available to check your K-Electric bill — online, via SMS, through a mobile app, and even by phone.
      </p>
    </div>
  );
}
...
function TableOfContentsNav() {
  const items = [
    { id: "ke-duplicate-bill", label: "K-Electric Duplicate Bill Guide" },
    { id: "why-check", label: "Why Check Your Bill Regularly" },
    { id: "bill-info", label: "What Information Is on Your Bill" },
    { id: "check-methods", label: "5 Ways to Check Your KE Bill" },
    { id: "tariff-rates", label: "K-Electric Tariff Rates 2026" },
...
function WhyCheckSection() {
  ...
  return (
    <div id="why-check" className="mb-10 scroll-mt-24">
      <SectionHeading icon={Shield} iconBg="linear-gradient(135deg, #FEE2E2, #FCA5A5)" iconColor="text-red-700" title="Why You Should Check Your KE Bill Regularly" />
      <p className="text-slate-600 mb-4" style={{ fontSize: "15px", lineHeight: 1.85 }}>
        Regular bill checking is more than just a financial habit — it is a smart utility management practice. By monitoring your K-Electric electricity bill each month, you can catch billing errors well before the due date, track your household or business consumption trends, plan your budget more effectively, and avoid late payment surcharges. KE bills include several components beyond the basic unit price — such as tariff adjustments, Fuel Price Adjustment (FPA), and government taxes.
      </p>
...
function BillInfoSection() {
  ...
  return (
    <div id="bill-info" className="mb-10 scroll-mt-24">
      <SectionHeading icon={Info} iconBg="linear-gradient(135deg, #FFF7ED, #FEE2D5)" iconColor="text-orange-600" title="What Information Is Printed on Your KE Bill" />
      <p className="text-slate-600 mb-5" style={{ fontSize: "15px", lineHeight: 1.85 }}>
        Before you dive into how to check your bill, it is worth knowing what you are looking for. Your K-Electric electricity bill contains several key data points. The most important is your <strong className="text-slate-800">14-digit Reference Number</strong> (also called Consumer Number), printed prominently at the top of every bill.
      </p>
  ...
  return (
    <div id="check-methods" className="mb-8 scroll-mt-24">
      <div className="flex items-center gap-3 mb-2">
        <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: "linear-gradient(135deg, #FEE2E2, #FCA5A5)" }}><Activity className="w-4 h-4 text-red-700" strokeWidth={2.5} /></div>
        <h3 className="text-slate-900 font-serif" style={{ fontSize: "20px", fontWeight: 800, letterSpacing: "-0.01em" }}>5 Ways to Check Your K-Electric Bill</h3>
      </div>
      ...
      <MethodCard num="1" heading="Check via BillCheck Online Portal (Fastest Method)" bg="bg-red-50">
        <p className="text-slate-600 mb-4" style={{ fontSize: "15px", lineHeight: 1.85 }}>The easiest way to check your K-Electric bill is through an online platform like <strong className="text-slate-800">BillCheck</strong>, which fetches real-time data directly from KE servers:</p>
        <div className="space-y-3">
          {[
            "Open your browser and visit the BillCheck K-Electric Bill page (you are already here!)",
            ...
            <div key={i} className="flex items-start gap-3">
              <div className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0 text-red-700" style={{ background: "linear-gradient(135deg, #FEE2E2, #FCA5A5)", fontSize: "11px", fontWeight: 800 }}>{String(i + 1).padStart(2, "0")}</div>
...
function TariffRatesSection() {
  const rows = [
    ...
    { slab: "2", units: "101 – 200", rate: "11.56", est: "PKR 1,930", cat: "Low Use", color: "#DC2626" },
    { slab: "3", units: "201 – 300", rate: "16.60", est: "PKR 3,590", cat: "Moderate", color: "#0369A1" },
    { slab: "4", units: "301 – 400", rate: "22.65", est: "PKR 5,855", cat: "Standard", color: "#DC2626" },
  ...
  return (
    <div id="tariff-rates" className="mb-10 scroll-mt-24">
      <SectionHeading icon={BarChart3} iconBg="linear-gradient(135deg, #FEE2E2, #FCA5A5)" iconColor="text-red-600" title="K-Electric Electricity Tariff Rates 2026" />
      <p className="text-slate-600 mb-5" style={{ fontSize: "15px", lineHeight: 1.85 }}>K-Electric uses a progressive slab-based tariff structure for residential consumers set by NEPRA. The more units you consume, the higher the per-unit rate.</p>
      ...
      <div className="mt-5 flex items-start gap-2.5 p-4 rounded-xl bg-red-50 border border-red-100">
        <Star className="w-4 h-4 text-red-600 shrink-0 mt-0.5" strokeWidth={2.5} />
        <p className="text-red-700" style={{ fontSize: "13px", lineHeight: 1.6 }}><strong>Tip:</strong> Reducing just 50–60 units can drop you into a lower slab and save PKR 1,000–2,000 per month.</p>
      </div>
    </div>
  );
}
...
function BillComponentsSection() {
  ...
  return (
    <div id="bill-components" className="mb-10 scroll-mt-24">
      <SectionHeading icon={BarChart3} iconBg="linear-gradient(135deg, #FFF7ED, #FEE2D5)" iconColor="text-orange-600" title="Understanding Your KE Bill Components" />
      <p className="text-slate-600 mb-5" style={{ fontSize: "15px", lineHeight: 1.85 }}>When you check your K-Electric bill, you will notice several line items that together make up the total payable amount. Here is a plain-language breakdown:</p>
      <div className="space-y-3">
        {items.map((item) => (
...
function BillErrorsSection() {
  return (
    <div id="bill-errors" className="mb-10 scroll-mt-24">
      ...
      <p className="text-slate-600 mb-4" style={{ fontSize: "15px", lineHeight: 1.85 }}>
        If you notice a discrepancy — incorrect meter reading, unexpected spike in units, wrong tariff category, or unexplained charge — visit your nearest K-Electric customer service centre with your CNIC and a copy of the bill. Submit a written complaint at the customer service counter. Alternatively, call <strong className="text-slate-800">118</strong> or file a complaint at <strong className="text-slate-800">ke.com.pk</strong>. Under NEPRA regulations, K-Electric must respond within <strong className="text-slate-800">15 working days</strong>.
      </p>
    </div>
  );
}
...
function ReduceBillSection() {
  const tips = [
    ...
    "Consider rooftop solar panels — KE&apos;s net metering policy lets you export surplus energy to offset your bill.",
  ];
  return (
    <div id="reduce-bill" className="mb-8 scroll-mt-24">
      <SectionHeading icon={TrendingUp} iconBg="linear-gradient(135deg, #ECFDF5, #D1FAE5)" iconColor="text-emerald-600" title="Practical Tips to Reduce Your KE Bill" />
...
function ConclusionBlock() {
  return (
    <div className="rounded-xl p-6 md:p-8 border-l-4 border-red-500" style={{ background: "linear-gradient(135deg, #FEF2F2 0%, #FEE2E2 50%, #FCA5A5 100%)" }}>
      ...
      <p className="text-red-800 italic" style={{ fontSize: "15px", lineHeight: 1.85 }}>
        Checking your K-Electric bill online has never been more accessible. Whether you prefer the instant convenience of <strong>BillCheck</strong>, the official KE portal, the no-internet simplicity of SMS to 8119, the mobile app, or the free helpline on 118 — multiple reliable methods are available. Make bill checking a regular monthly habit: verify your charges, monitor consumption trends, and act immediately on any discrepancy you spot. Bookmark this page and use the K-Electric Bill Check tool at the top of this page to fetch your latest bill right now.
      </p>
    </div>
  );
}

function KEDuplicateBillSection() {
  return (
    <div id="ke-duplicate-bill" className="mb-10 scroll-mt-24">
      <SectionHeading icon={Activity} iconBg="linear-gradient(135deg, #FEE2E2, #FECACA)" iconColor="text-red-700" title="How to Get a Duplicate K-Electric Bill Online" />
      <p className="text-slate-600 mb-4" style={{ fontSize: "15px", lineHeight: 1.85 }}>
        Lost your original K-Electric bill or need a second copy? Getting a <strong className="text-slate-800">duplicate KE bill</strong> is straightforward. Many consumers in Karachi need a duplicate bill for payment records, tax filing, or when the physical copy is misplaced. All you need is your <strong className="text-slate-800">14-digit reference number</strong> (also called your consumer number), printed on any previous K-Electric electricity bill.
      </p>
      <div className="space-y-3 mb-5">
        {[
          "Locate your 14-digit reference number from any previous KE bill or SMS from 8119.",
          "Enter the reference number in the K-Electric Bill Check tool at the top of this page.",
          "Click Check Bill Now — your current duplicate bill loads in seconds.",
          "Download or print a PDF copy of your duplicate KE bill for your records.",
        ].map((step, i) => (
          <div key={i} className="flex items-start gap-3">
      ...
      <div className="flex items-start gap-2.5 p-4 rounded-xl bg-red-50 border border-red-100">
        <Star className="w-4 h-4 text-red-600 shrink-0 mt-0.5" strokeWidth={2.5} />
        <p className="text-red-700" style={{ fontSize: "13px", lineHeight: 1.6 }}><strong>Important:</strong> If you need an older duplicate KE bill, visit your nearest K-Electric customer service centre in Karachi.</p>
      </div>
    </div>
  );
}
