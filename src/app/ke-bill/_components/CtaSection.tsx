    ...
    <motion.section initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }} className="mt-16 md:mt-24 mb-8">
      <div className="relative overflow-hidden rounded-2xl p-8 md:p-16 text-center shadow-2xl shadow-red-900/10" style={{ background: "linear-gradient(135deg, #DC2626 0%, #EF4444 50%, #FCA5A5 100%)" }}>
        ...
        <div className="relative z-10">
          ...
          <p className="text-red-100 max-w-xl mx-auto mb-10" style={{ fontSize: "16px", lineHeight: 1.6, fontWeight: 500 }}>Check electricity, gas and other utility bills from all major companies in Pakistan — free, fast and secure.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/bill/electricity" className="flex items-center justify-center gap-2 px-8 py-4 bg-white text-red-700 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1" style={{ fontWeight: 700, fontSize: "15px" }}>
