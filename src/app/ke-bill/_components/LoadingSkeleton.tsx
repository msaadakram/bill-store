  ...
  return (
    ...
    >
      ...
      <div className="p-6 space-y-5">
        <div className="h-28 bg-gradient-to-br from-red-50 to-rose-50 rounded-xl animate-pulse" />
        ...
        <div className="relative mb-4">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <motion.div animate={{ scale: [1, 1.2, 1] }} transition={{ repeat: Infinity, duration: 1 }}>
              <Zap className="w-7 h-7 text-red-600" strokeWidth={2.5} />
            </motion.div>
          </div>
        </div>
        <p className="text-slate-700" style={{ fontSize: "15px", fontWeight: 600 }}>Fetching your bill…</p>
        <p className="text-slate-400 mt-1" style={{ fontSize: "13px" }}>Connecting to K-Electric servers</p>
