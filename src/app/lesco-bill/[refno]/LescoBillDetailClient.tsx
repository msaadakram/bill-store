...
export function LescoBillDetailClient({
  refno,
  bill,
  error,
  pitcRedirect,
  ...
  const handleOpenPitc = () => {
    ...
    window.open(
      `https://bill.pitc.com.pk/gbill.aspx?refno=${encodeURIComponent(refno)}&type=${pitcType}`,
      "_blank",
      "noopener,noreferrer",
    );
  };
        ...
        <div className="text-center px-4 max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              ...
              style={{
                background: "linear-gradient(135deg, #3E8B8E, #5A9FA2)",
                fontSize: "14px",
                fontWeight: 700,
              }}
            >
