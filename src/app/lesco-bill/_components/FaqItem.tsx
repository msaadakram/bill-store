  ...
  return (
    ...
    >
      <button
        ...
        className="w-full flex items-center justify-between gap-4 p-5 md:p-6 text-left bg-white hover:bg-slate-50 transition-colors"
      >
        <span
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <div
              className="px-5 md:px-6 pb-5 md:pb-6 text-slate-600 bg-white"
