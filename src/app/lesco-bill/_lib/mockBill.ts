...
/** Generate a randomised mock LESCO bill for demo purposes */
export function mockBill(ref: string, mode: InputMode): BillDetails {
  ...
  const addresses = [
    ...
    "Flat 3B, Johar Town Block D, Lahore",
    "House #45, DHA Phase 5, Lahore",
    "4-Garhi Shahu, Lahore Cantt",
  ];
  ...
  return {
    ...
    customerId: mode === "customer" ? ref : `CID-${ref.slice(0, 6)}`,
