  ...
  return (
    <div className="space-y-5 lg:sticky lg:top-8 h-fit">
      ...
      <motion.div
        ...
        className="rounded-xl overflow-hidden shadow-lg shadow-red-900/10"
        style={{
        ...
        <div className="p-6">
          <div className="flex items-center gap-4 mb-5">
            <div className="w-12 h-12 rounded-xl bg-white/15 flex items-center justify-center border border-white/10">
              <Flame className="w-6 h-6 text-yellow-300" strokeWidth={2.5} />
            </div>
            <div>
              <div
              ...
              <div className="text-red-200" style={{ fontSize: "13px" }}>
