  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #DC2626 0%, #EF4444 60%, #FCA5A5 100%)",
        }}
      >
        ...
        <div className="flex items-center gap-3 md:gap-4 relative">
          <div className="w-11 h-11 md:w-12 md:h-12 rounded-2xl bg-white/15 backdrop-blur-sm border border-white/20 flex items-center justify-center">
            <Flame className="w-5 h-5 md:w-6 md:h-6 text-yellow-300" strokeWidth={2.5} />
          </div>
          <div>
            <div
            ...
            <div className="text-red-200" style={{ fontSize: "12px" }}>
              {bill.billMonth}
            </div>
          </div>
        </div>
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              {(item as any).copy && (
                <button
                  onClick={handleCopy}
                  className="shrink-0 w-7 h-7 rounded-lg flex items-center justify-center bg-white border border-slate-200 hover:border-red-400 hover:bg-red-50 transition-colors"
                >
                  {copied ? (
