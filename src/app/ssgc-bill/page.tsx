...
import { SsgcHero } from "./_components/SsgcHero";
import { BillSearchFlow } from "./_components/BillSearchFlow";
import { BillResultCard } from "./_components/BillResultCard";
import { SsgcSidebar } from "./_components/SsgcSidebar";
import { BlogGuideSection } from "./_components/BlogGuideSection";
import { FaqSection } from "./_components/FaqSection";
import { CtaSection } from "./_components/CtaSection";

const PITC_URL = "https://bill.pitc.com.pk/ssgcbill/general?refno=";

const MAX_HISTORY = 6;
const HISTORY_KEY = "ssgc_search_history";
...
export default function SsgcBillPage() {
  ...
  <div key="loading" className="lg:col-span-2">
    ...
    />
          ...
          {/* Sidebar */}
          {step === "input" && (
            <SsgcSidebar history={history} onLoad={loadFromHistory} onDelete={deleteHistory} onClear={clearHistory} />
          )}
        </div>
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center shadow-lg shadow-red-500/20 shrink-0 relative overflow-hidden group bg-gradient-to-br from-red-600 to-red-800">
              ...
              <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 md:w-8 md:h-8 text-white drop-shadow-md transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2C9.5 2 7 3 5.5 5C3.5 7.5 3 13 6 18C8 22 12 22 12 22C12 22 16 22 18 18C21 13 20.5 7.5 18.5 5C17 3 14.5 2 12 2ZM12 7C12.8 5.5 14 4.5 12 3.5C10 4.5 11.2 5.5 12 7Z" fill="currentColor" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <div>
              <h2 className="text-slate-900" style={{ fontSize: "18px", fontWeight: 800, letterSpacing: "-0.01em" }}>Check SSGC Bill</h2>
