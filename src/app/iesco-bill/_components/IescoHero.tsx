          ...
          <div>
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: "13px", fontWeight: 600 }}
              >
                IESCO — Official Bill Check Portal
              </span>
            </motion.div>
            ...
            >
              Check Your IESCO Electricity Bill Online
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-teal-200 mb-6 md:mb-8"
              style={{
                fontSize: "clamp(15px, 2vw, 17px)",
                lineHeight: 1.7,
              }}
            >
              Islamabad Electric Supply Company (IESCO) serves over{" "}
              <strong className="text-white">3.5 million consumers</strong> in
              Islamabad &amp; Rawalpindi. Instantly check and download your
              bill.
            </motion.p>
