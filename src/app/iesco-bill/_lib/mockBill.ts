...
/** Generate a randomised mock IESCO bill for demo purposes */
export function mockBill(ref: string, mode: InputMode): BillDetails {
  ...
  const addresses = [
    "House #23, Street 12, F-10/2, Islamabad",
    "Plot 56, Bahria Town Phase 8, Rawalpindi",
    "Apartment 7B, G-11 Markaz, Islamabad",
    "House #8, Westridge 1, Rawalpindi Cantt",
    "Flat 15, I-8/3, Islamabad",
    "Shop #12, Saddar Bazaar, Rawalpindi",
  ];
  ...
  return {
    ...
    referenceNo: mode === "reference" ? ref : `0120${ref.padEnd(10, "0").slice(0, 10)}`,
    customerId: mode === "customer" ? ref : `IID-${ref.slice(0, 6)}`,
